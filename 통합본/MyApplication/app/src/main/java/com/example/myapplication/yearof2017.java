 ...
 * 작성자 : 2016039059 김선형
 * 수정일 : 2020.06.26
 * 프로그램명 : 입학연도 2017년 체크리스트
 * 프로그램 설명 : 입학년도 2017년 체크리스트 뷰
 **************************************/
...
public class yearof2017 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2017.this);
                ...
                ad.setMultiChoiceItems(sub_items, new boolean[]{false}, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        if(b){
                            Toast.makeText(yearof2017.this,sub_items[i],Toast.LENGTH_SHORT).show();;
                ...
                final EditText et = new EditText(yearof2017.this);
                ad.setView(et);
            ...
            public void onClick(View view) {
                ...
                ad.setMultiChoiceItems(basic_items, new boolean[]{false,false,false,false,false,false,false,false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        ...
                        if(b){
                            Toast.makeText(yearof2017.this,basic_items[i],Toast.LENGTH_SHORT).show();;
            ...
            public void onClick(View view) {
                ...
                ad.setMultiChoiceItems(hard_items, new boolean[]{false,false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        ...
                        if(b){
                            Toast.makeText(yearof2017.this,hard_items[i],Toast.LENGTH_SHORT).show();;
...
*/
                ...
                Intent mainintent=new Intent(yearof2017.this,Box.class);
                mainintent.putExtra("userID",userID);//아이디

                yearof2017.this.startActivity(mainintent);
            }
