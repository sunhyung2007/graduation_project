...
public class yearof2018 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final String[] sub_items = new String[]{"동양고전이야기","문화로 보는 생활사", "근현대의 역사와 인물","한국속의 세계문화유산","충북지역문화와 동아시아 문화교류"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요  5개중 하나라도 들었으면 선택하지 마세요");

                //boolean 리스트를 만들고 전부 false로 초기화
                ad.setMultiChoiceItems(sub_items, new boolean[]{false,false,false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        if(b){
                            Toast.makeText(yearof2018.this,sub_items[i],Toast.LENGTH_SHORT).show();;
                ...
                final EditText et = new EditText(yearof2018.this);
                ad.setView(et);
        ...
        btn_basic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] basic_items = new String[]{"대학 글쓰기","Action English","영어읽기와 토론","발표와 토론","수학1","수학2","기초프로그래밍","기초통계학및실습", "맛보기물리학및실험","응용컴퓨터프로그래밍","외궁어로서의 한국어1","외궁어로서의 한국어2"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
                ad.setMultiChoiceItems(basic_items, new boolean[]{false,false,false,false,false,false,false,false,false,false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {

                        if(b){
                            Toast.makeText(yearof2018.this,basic_items[i],Toast.LENGTH_SHORT).show();;
        ...
        btn_hard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] hard_items = new String[]{"공업 법규와 창업","공학 윤리와 역사","문학과 문화영역 또는 역사와 철학"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
                ad.setMultiChoiceItems(hard_items, new boolean[]{false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {

                        if(b){
                            Toast.makeText(yearof2018.this,hard_items[i],Toast.LENGTH_SHORT).show();;
        ...
        btn_nes1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] nes1_items = new String[]{"컴퓨터시스템개론","자료구조","컴퓨터 구조","프로그래밍언어론","운영체제","객체지향 설계","알고리즘","소프트웨어공학","캡스톤 디자인1","캡스톤 디자인2"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
        ...
        btn_select1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] select1_items = new String[]{"창의공학설계","소프트웨어도구실험","객체지향프로그래밍","시스템프로그래밍","인간컴퓨터상호작용","컴파일러","웹기반소프트웨어개발","컴퓨터네트워크","확률과 통계"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
                ad.setMultiChoiceItems(select1_items, new boolean[]{false,false,false,false,false,false,false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        if(b){
        ...
        btn_select2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] select2_items = new String[]{"데이터베이스시스템","펌웨어프로그래밍","컴퓨터그래픽스","임베디드시스템","영상처리","인공지능","산학특강초청세미나1","빅데이터베이스설계","정보보호","정보검색"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
        ...
        btn_select3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] select3_items = new String[]{"산학특강초청세미나2","데이터분석시각화","비정형데이터처리"};
                AlertDialog.Builder ad = new AlertDialog.Builder(yearof2018.this);
                ad.setTitle("듣지 못한 과목을 선택하세요");
                ad.setMultiChoiceItems(select3_items, new boolean[]{false,false,false}, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                        if(b){
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
             /*   db.UserDesc.insertAll(new Userinfo(idText.getText().toString(),pwdText.getText().toString(),
...
*/
                ...
                Intent mainintent=new Intent(yearof2018.this,Box.class);
                mainintent.putExtra("userID",userID);//아이디

                yearof2018.this.startActivity(mainintent);
            }
